 ...
 * Read TREC topics.
 * <p>
 * From org.apache.lucene.benchmark.quality.trec.TrecTopicsReader 
 * (modified by T.Y.Tung to fit the NTU project's need)
 * <p>
...
public class TrecTopicsReader {
	  ...
	  private static final String newline = " "; //modify by T.Y.Tung
  ...
  public QualityQuery[] readQueries(BufferedReader reader) throws IOException {
    ...
    try {
      while (null!=(sb=read(reader,"<top>",null,false,false))) {
        ...
        // if title is on next line (e.g. 510, 511)
        if (title.equals("")) { //modify by T.Y.Tung
        	sb = read(reader,"<desc>",null,false,true);
        ...
        // narrative
        sb = read(reader,"</top>",null,false,true);
